...
import com.suatae.mechinasmagick.common.init.BlockRoadBase;
...
public class BlockRoadStone extends BlockRoadBase implements ITileEntityProvider {
	public BlockRoadStone() {
		super(Material.rock, "pickaxe", 0, 2.5F, 0.4F, 1.5F, 10.0F, Block.soundTypeStone);
	...
	public boolean onBlockActivated(World world, int X, int Y, int Z, EntityPlayer Player,
		...
		if (!world.isRemote) {
			...
			if (te.getCamo() != null && Player.isSneaking() == true && !ConfigUtil.Multiplayer) {
