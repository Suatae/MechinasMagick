...
public class BlockCoreBrass extends BlockMachineCore implements ITileEntityProvider {

	public BlockCoreBrass() {
		this.setBlockName(REF.NAME.BLOCK.cBrass);
	}

	@Override
	public TileEntity createNewTileEntity(World world, int var2) {
		return new TileEntityBrass();
	}
