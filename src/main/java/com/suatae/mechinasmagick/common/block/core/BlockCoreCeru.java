...
public class BlockCoreCeru extends BlockMachineCore implements ITileEntityProvider {

	public BlockCoreCeru() {
		this.setBlockName(REF.NAME.BLOCK.cCeru);
	}

	@Override
	public TileEntity createNewTileEntity(World world, int var2) {
		return new TileEntityCeru();
	}
