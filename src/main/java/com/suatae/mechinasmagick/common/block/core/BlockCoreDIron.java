...
public class BlockCoreDIron extends BlockMachineCore implements ITileEntityProvider {

	public BlockCoreDIron() {
		this.setBlockName(REF.NAME.BLOCK.cDiron);
	}

	@Override
	public TileEntity createNewTileEntity(World world, int var2) {
		return new TileEntityDIron();
	}
