...
public class BlockCoreDesi extends BlockMachineCore implements ITileEntityProvider {

	public BlockCoreDesi() {
		this.setBlockName(REF.NAME.BLOCK.cDesi);
	}

	@Override
	public TileEntity createNewTileEntity(World world, int var2) {
		return new TileEntityDesi();
	}
