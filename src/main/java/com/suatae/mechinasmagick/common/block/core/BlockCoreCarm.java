...
public class BlockCoreCarm extends BlockMachineCore implements ITileEntityProvider {

	public BlockCoreCarm() {
		this.setBlockName(REF.NAME.BLOCK.cCarm);
	}

	@Override
	public TileEntity createNewTileEntity(World world, int var2) {
		return new TileEntityCarm();
	}
