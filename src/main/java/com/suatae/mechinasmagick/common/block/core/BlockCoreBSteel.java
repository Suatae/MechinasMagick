...
public class BlockCoreBSteel extends BlockMachineCore implements ITileEntityProvider {

	public BlockCoreBSteel() {
		this.setBlockName(REF.NAME.BLOCK.cBSteel);
	}

	@Override
	public TileEntity createNewTileEntity(World world, int var2) {
		return new TileEntityBSteel();
	}
