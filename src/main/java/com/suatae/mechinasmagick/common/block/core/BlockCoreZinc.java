...
public class BlockCoreZinc extends BlockMachineCore implements ITileEntityProvider {

	public BlockCoreZinc() {
		this.setBlockName(REF.NAME.BLOCK.cZinc);
	}

	@Override
	public TileEntity createNewTileEntity(World world, int var2) {
		return new TileEntityZinc();
	}
}
