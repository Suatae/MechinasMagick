...
/**
 * CropNew - Suatae Created using Tabula 4.1.1
 */
public class Crop00 extends ModelBase {
	...
	public Crop00() {
		...
		this.Base01.addBox(-3.0F, 0.0F, -3.0F, 6, 10, 6, 0.0F);
		...
		this.Base04.addBox(-3.0F, 0.0F, -3.0F, 6, 10, 6, 0.0F);
		...
		this.Base02.addBox(-3.0F, 0.0F, -3.0F, 6, 10, 6, 0.0F);
		...
		this.Base03.addBox(-3.0F, 0.0F, -3.0F, 6, 10, 6, 0.0F);
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
		...
		GL11.glTranslatef(this.Base01.rotationPointX * f5, this.Base01.rotationPointY * f5,
				this.Base01.rotationPointZ * f5);
		...
		GL11.glTranslatef(this.Base04.rotationPointX * f5, this.Base04.rotationPointY * f5,
				this.Base04.rotationPointZ * f5);
		GL11.glScaled(0.5D, 0.5D, 0.5D);
		GL11.glTranslatef(-this.Base04.offsetX, -this.Base04.offsetY, -this.Base04.offsetZ);
		GL11.glTranslatef(-this.Base04.rotationPointX * f5, -this.Base04.rotationPointY * f5,
				-this.Base04.rotationPointZ * f5);
		...
		GL11.glTranslatef(this.Base02.rotationPointX * f5, this.Base02.rotationPointY * f5,
				this.Base02.rotationPointZ * f5);
		GL11.glScaled(0.5D, 0.5D, 0.5D);
		GL11.glTranslatef(-this.Base02.offsetX, -this.Base02.offsetY, -this.Base02.offsetZ);
		GL11.glTranslatef(-this.Base02.rotationPointX * f5, -this.Base02.rotationPointY * f5,
				-this.Base02.rotationPointZ * f5);
		...
		GL11.glTranslatef(this.Base03.rotationPointX * f5, this.Base03.rotationPointY * f5,
				this.Base03.rotationPointZ * f5);
		GL11.glScaled(0.5D, 0.5D, 0.5D);
		GL11.glTranslatef(-this.Base03.offsetX, -this.Base03.offsetY, -this.Base03.offsetZ);
		GL11.glTranslatef(-this.Base03.rotationPointX * f5, -this.Base03.rotationPointY * f5,
				-this.Base03.rotationPointZ * f5);
